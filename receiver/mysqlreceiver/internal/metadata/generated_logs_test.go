		...
		t.Run(tt.name, func(t *testing.T) {
			...
			for i := 0; i < lrs.Len(); i++ {
				...
				case "db.server.query_sample":
					...
					attrVal, ok = lr.Attributes().Get("trace.parent_id")
					assert.True(t, ok)
					assert.Equal(t, "trace.parent_id-val", attrVal.Str())
